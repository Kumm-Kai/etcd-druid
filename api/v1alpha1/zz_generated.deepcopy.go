...
func (in *EtcdSpec) DeepCopyInto(out *EtcdSpec) {
	*out = *in
	...
	if in.StatefulSetStartIndex != nil {
		in, out := &in.StatefulSetStartIndex, &out.StatefulSetStartIndex
		*out = new(int32)
		**out = **in
	}
	if in.AdditionalHostAliases != nil {
		in, out := &in.AdditionalHostAliases, &out.AdditionalHostAliases
